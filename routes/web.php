...
Route::get('/order/finished/{productsTransaction:id}',[OrderControllers::class, 'orderFinished'])->name('front.order_finished'); // 'front.details ubah jadi front_order.details karena bentrok dengan line 9
