                    ...
                    <div class="col-md-6">
                        <div class="category-banner__item border-radius-10 mb-5">
                            <img loading="lazy" class="h-auto"
                                src="{{ Storage::url($product->thumbnail) }}" width="690"
                            ...
                            <div class="category-banner__item-content">
                                ...
                                <a href="{{ route('front.details', $product->slug) }}" class="btn-link default-underline text-uppercase fw-medium">{{ __('front.shop_now') }}</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
